...
namespace Ts_Solutions.iOS
{
	public static class ViewExtensions
	{
		...
		public static UITextField SetLeftPadding(this UITextField text, float pad = 5)
		{
			UIView paddingView = new UIView(new CGRect(0, 0, pad, text.Bounds.Height));
			text.LeftView = paddingView;
			text.LeftViewMode = UITextFieldViewMode.Always;
			return null;
		}

		public static UIView ShadowCell(this UIView view, CGRect rect, float bezierRadius, CGSize offset, float opacity)
		{
			var temprect = rect;
			var shadowPath = UIBezierPath.FromRoundedRect(temprect, bezierRadius);
